package com.example.springintegrationflow;

import com.example.springintegrationflow.gateways.FileWriterGateway;
...
public class SpringIntegrationFlowApplication {

    public static void main(String[] args) {
        SpringApplication.run(SpringIntegrationFlowApplication.class, args);
    }
